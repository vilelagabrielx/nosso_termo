...
export const FALLBACK_WORDS_BY_LENGTH: Record<number, string[]> = {
  ...
  5: ['TERMO', 'PORTA', 'VENTO', 'CHAVE', 'PLACA', 'PRATO', 'FESTA', 'LIVRO', 'CORPO', 'ALMA', 'TEMPO', 'NOITE', 'JOGO', 'CAMPO', 'PEDRA', 'FOLHA', 'CHUVA', 'CANETA', 'PASTA', 'MANGA', 'AMIGO', 'GRUPO', 'TEXTO', 'FORÇA', 'MENTE', 'RADIO', 'TRENO', 'SONHO', 'AREIA', 'GENTE'],
